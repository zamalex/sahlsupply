...
enum CardDesign { card, glass, horizontal }

CardDesign convertTextToCardDesign(String cardDesign) {
  switch (cardDesign) {
    case 'glass':
...
class ProductConfig {
  ...
  ProductConfig.empty() {
    ...
    cardDesign = convertTextToCardDesign(kProductCard.cardDesign);
  ...
  ProductConfig.fromJson(dynamic json) {
    ...
    if (json['cardDesign'] != null) {
      cardDesign = convertTextToCardDesign(json['cardDesign']);
    } else {
