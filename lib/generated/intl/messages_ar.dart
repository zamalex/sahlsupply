...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addToCart": MessageLookupByLibrary.simpleMessage("أضف إلى القفة"),
        "addToCartMaximum":
            MessageLookupByLibrary.simpleMessage("تم تجاوز الكمية القصوى"),
        "addToCartSucessfully":
            MessageLookupByLibrary.simpleMessage("تمت تحديث القفة بنجاح"),
        ...
        "availability": MessageLookupByLibrary.simpleMessage("الوفرة"),
        "availablePoints": m2,
        ...
        "cart": MessageLookupByLibrary.simpleMessage("القفة"),
        "cartDiscount": MessageLookupByLibrary.simpleMessage("خصم على القفة"),
        ...
        "clearCart": MessageLookupByLibrary.simpleMessage("تفريغ القفة"),
        "clearConversation":
        ...
        "confirmClearTheCart": MessageLookupByLibrary.simpleMessage(
            "هل أنت متأكد أنك تريد مسح قفة التسوق؟"),
        ...
        "draft": MessageLookupByLibrary.simpleMessage("مشروع"),
        ...
        "emailDoesNotExist": MessageLookupByLibrary.simpleMessage(
            "حساب الإيميل الذي أدخلته غير موجود. حاول مرة اخرى."),
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("خانة الإيميل مطلوبة"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("اشتراك البريد الإلكتروني"),
        "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
            "يبدو أنك لم تقم بإضافة أي سلع إلى القفة بعد. ابدأ التسوق الآن."),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("اسم المستخدم / الإيميل فارغ"),
        ...
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("خصم ثابت على القفة"),
        ...
        "loginSuccess":
            MessageLookupByLibrary.simpleMessage("تسجيل الدخول بنجاح!"),
        "loginToComment":
        ...
        "myCart": MessageLookupByLibrary.simpleMessage("قُفّتي"),
        ...
        "orderHistory": MessageLookupByLibrary.simpleMessage("سِجِل الطلبات"),
        "orderId":
        ...
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "يمكنك التحقق من حالة طلبك باستخدام ميزة حالة التسليم الخاصة بنا. ستتلقى رسالة تأكيد بالإيميل مع تفاصيل طلبك ورابط لتتبع حالته."),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "يمكنك تسجيل الدخول إلى حسابك باستخدام الإيميل وكلمة المرور المحددة مسبقًا. على حسابك ، يمكنك تحرير بيانات ملفك الشخصي ، والتحقق من سجل المعاملات ، وتعديل الاشتراك في النشرة الإخبارية."),
        "orderSuccessTitle1":
        ...
        "paidStatus": MessageLookupByLibrary.simpleMessage("الحالة المدفوعة"),
        ...
        "userExists": MessageLookupByLibrary.simpleMessage(
            "اسم المستخدم / الإيميل هذا غير متوفر."),
        "userNameInCorrect": MessageLookupByLibrary.simpleMessage(
            "خطأ في اسم المستخدم أو كلمة السر."),
        ...
        "yourBagIsEmpty": MessageLookupByLibrary.simpleMessage("قفتك فارغة"),
        "yourBookingDetail":
