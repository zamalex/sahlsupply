...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(currency) => "${currency} wordt niet ondersteund";

  static String m7(day) => "${day} dagen geleden";

  static String m8(total) => "~${total} km";

  static String m9(timeLeft) => "Eindigt over ${timeLeft}";

  static String m10(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m11(message) => "Fout: ${message}";

  static String m12(time) => "Verloopt over ${time}";

  static String m13(total) => ">${total} km";

  static String m14(hour) => "${hour} uur geleden";
  ...
  static String m17(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m18(currency, amount) =>
      "Het minimumbedrag voor het gebruik van deze betaling is ${currency} ${amount}";

  static String m19(minute) => "${minute} minuten geleden";

  static String m20(month) => "${month} maanden geleden";

  static String m21(store) => "Meer van ${store}";

  static String m22(itemCount) => "${itemCount} items";

  static String m23(price) => "Opties totaal: ${price}";

  static String m24(total) => "Aantal: ${total}";

  static String m25(percent) => "Verkoop ${percent} %";

  static String m26(second) => "${second} seconden geleden";

  static String m27(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m28(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m29(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m30(total) => "${total} producten";
  ...
  static String m32(date) => "Geldig tot ${date}";

  static String m33(message) => "Waarschuwing: ${message}";
  ...
  static String m35(length) => "We hebben ${length} producten gevonden";

  static String m36(week) => "Week ${week}";

  static String m37(name) => "Welkom ${name}";

  static String m38(year) => "${year} jaar geleden";

  static String m39(total) => "Je hebt toegewezen aan bestelling #${total}";
