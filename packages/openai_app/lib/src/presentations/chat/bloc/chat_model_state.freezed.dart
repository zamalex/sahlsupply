...
/// @nodoc
abstract class _$$_ChatModelStateCopyWith<$Res>
    implements $ChatModelStateCopyWith<$Res> {
  factory _$$_ChatModelStateCopyWith(
          _$_ChatModelState value, $Res Function(_$_ChatModelState) then) =
      __$$_ChatModelStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? identifier, List<Chat> chats});
}
...
/// @nodoc
class __$$_ChatModelStateCopyWithImpl<$Res>
    extends _$ChatModelStateCopyWithImpl<$Res, _$_ChatModelState>
    implements _$$_ChatModelStateCopyWith<$Res> {
  __$$_ChatModelStateCopyWithImpl(
      _$_ChatModelState _value, $Res Function(_$_ChatModelState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ChatModelState(
      identifier: freezed == identifier
          ? _value.identifier
          : identifier // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_ChatModelState
    with DiagnosticableTreeMixin
    implements _ChatModelState {
  const _$_ChatModelState({this.identifier, required final List<Chat> chats})
      : _chats = chats;
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ChatModelStateCopyWith<_$_ChatModelState> get copyWith =>
      __$$_ChatModelStateCopyWithImpl<_$_ChatModelState>(this, _$identity);
}

abstract class _ChatModelState implements ChatModelState {
  const factory _ChatModelState(
      {final String? identifier,
      required final List<Chat> chats}) = _$_ChatModelState;
