...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  void _onSpeakTap(Message message, ChatDetailState state) {
    var previousMessageSpeech = state.data.messaageSpeech;
    state.maybeWhen(
      speakText: (_) {
        _bloc.add(
          ChatDetailEvent.cancelSpeech(message.id, previousMessageSpeech, () {
          ...
          return WillPopScope(
            ...
            child: Stack(
              children: [
                ...
                Scaffold(
                  appBar: AppBar(
                    title: Text(S.of(context).chatDetail),
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ChatMessage(
                              message: message,
                              isSpeaking: state.maybeWhen(
                                stopSpeak: (_) => false,
                                orElse: () =>
                                    messageSpeech == message.id ? true : false,
                              ),
                              onSpeakTap: () => _onSpeakTap(message, state),
