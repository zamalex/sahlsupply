...
class MainRoutes {
  static Map<String, WidgetBuilder> getAll(RouteSettings settings) => {
        ...
        TextGenerateScreen.routeName: (context) {
          ...
          return BlocProvider<TextGenerateBloc>(
            create: (context) => injector(param1: identifier),
            child: TextGenerateScreen(loginCallback: loginCallback),
          );
        },
        ImageGenerateScreen.routeName: (context) {
          String? identifier;
          VoidCallback? loginCallback;
          final args = settings.arguments;
          if (args is Map) {
          ...
          return BlocProvider<ImageGenerateBloc>(
            create: (context) => injector(param1: identifier),
            child: ImageGenerateScreen(loginCallback: loginCallback),
          );
        },
