...
/// @nodoc
abstract class _$$_SubPromptUseCaseCopyWith<$Res>
    implements $SubPromptUseCaseCopyWith<$Res> {
  factory _$$_SubPromptUseCaseCopyWith(
          _$_SubPromptUseCase value, $Res Function(_$_SubPromptUseCase) then) =
      __$$_SubPromptUseCaseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$$_SubPromptUseCaseCopyWithImpl<$Res>
    extends _$SubPromptUseCaseCopyWithImpl<$Res, _$_SubPromptUseCase>
    implements _$$_SubPromptUseCaseCopyWith<$Res> {
  __$$_SubPromptUseCaseCopyWithImpl(
      _$_SubPromptUseCase _value, $Res Function(_$_SubPromptUseCase) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SubPromptUseCase(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_SubPromptUseCase
    with DiagnosticableTreeMixin
    implements _SubPromptUseCase {
  const _$_SubPromptUseCase(
      {required this.name,
      required this.description,
      required this.type,
      this.promptText = ''});

  factory _$_SubPromptUseCase.fromJson(Map<String, dynamic> json) =>
      _$$_SubPromptUseCaseFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SubPromptUseCaseCopyWith<_$_SubPromptUseCase> get copyWith =>
      __$$_SubPromptUseCaseCopyWithImpl<_$_SubPromptUseCase>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SubPromptUseCaseToJson(
      this,
    );
  }
}
...
abstract class _SubPromptUseCase implements SubPromptUseCase {
  const factory _SubPromptUseCase(
      ...
      final String promptText}) = _$_SubPromptUseCase;

  factory _SubPromptUseCase.fromJson(Map<String, dynamic> json) =
      _$_SubPromptUseCase.fromJson;
